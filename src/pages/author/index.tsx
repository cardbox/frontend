...
export const AuthorPage = () => {
  ...
  if (isLoading || !(userInfo && cards)) return null;
          ...
          <UserHeader>
            <UserFace>
              <UserFaceContent>
                ...
                <UserFacePosition>{work}</UserFacePosition>
                <UserLocation>Saint-Petersburg, Russia</UserLocation>
                <UserFaceDescription>{bio}</UserFaceDescription>
              </UserFaceContent>
            </UserFace>
            <UserSocial>
              <SocialStaff>
                ...
                <SocialStaffList>
                  <SocialStaffItem>
                    ...
                    <SocialStaffItemText>{username}</SocialStaffItemText>
                  </SocialStaffItem>
                  <SocialStaffItem>
                    <Avatar size="small" src={avatar} />
                    <SocialStaffItemText>{username}</SocialStaffItemText>
...
withStart(model.pageLoaded, AuthorPage);
