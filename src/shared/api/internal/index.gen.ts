...
export const authParams = createEffect<AuthParams, AuthParamsDone, AuthParamsFail>({
  async handler({ body }) {
...
export const cardsSearch = createEffect<CardsSearch, CardsSearchDone, CardsSearchFail>({
  async handler({ body }) {
...
export type CardsCreateFail =
  ...
  | GenericErrors;
export const cardsCreate = createEffect<CardsCreate, CardsCreateDone, CardsCreateFail>({
  async handler({ body }) {
...
export type CardsDeleteFail =
  ...
  | GenericErrors;
export const cardsDelete = createEffect<CardsDelete, CardsDeleteDone, CardsDeleteFail>({
  async handler({ body }) {
...
export type CardsUnsaveFail =
  ...
  | GenericErrors;
export const cardsUnsave = createEffect<CardsUnsave, CardsUnsaveDone, CardsUnsaveFail>({
  async handler({ body }) {
...
export const usersSearch = createEffect<UsersSearch, UsersSearchDone, UsersSearchFail>({
  async handler({ body }) {
